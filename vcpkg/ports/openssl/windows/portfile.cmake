...
# Git for Windows ships a minimal perl.exe that breaks OpenSSL's Configure step.
# Prefer a full Perl (e.g. Strawberry) when the workflow sets PERL.
if(DEFINED ENV{PERL} AND NOT "$ENV{PERL}" STREQUAL "")
    cmake_path(CONVERT "$ENV{PERL}" TO_CMAKE_PATH_LIST PERL NORMALIZE)
    if(NOT EXISTS "${PERL}")
        message(FATAL_ERROR "PERL environment variable points to missing file: ${PERL}")
    endif()
    set(PERL "${PERL}" CACHE FILEPATH "Perl from environment" FORCE)
else()
