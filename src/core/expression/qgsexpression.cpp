...
{
  //global variables
  sVariableHelpTexts()->insert( u"qgis_version"_s, QCoreApplication::translate( "variable_help", "Current Hake GeoDesk – Desktop GIS version string." ) );
  sVariableHelpTexts()->insert( u"qgis_version_no"_s, QCoreApplication::translate( "variable_help", "Current Hake GeoDesk – Desktop GIS version number." ) );
  sVariableHelpTexts()->insert( u"qgis_release_name"_s, QCoreApplication::translate( "variable_help", "Current Hake GeoDesk – Desktop GIS release name." ) );
  sVariableHelpTexts()->insert( u"qgis_short_version"_s, QCoreApplication::translate( "variable_help", "Short Hake GeoDesk – Desktop GIS version string." ) );
  ...
  sVariableHelpTexts()->insert( u"qgis_platform"_s, QCoreApplication::translate( "variable_help", "Hake GeoDesk – Desktop GIS platform, e.g., 'desktop' or 'server'." ) );
  sVariableHelpTexts()->insert( u"qgis_locale"_s, QCoreApplication::translate( "variable_help", "Two letter identifier for current Hake GeoDesk – Desktop GIS locale." ) );
  sVariableHelpTexts()->insert( u"hake_version"_s, QCoreApplication::translate( "variable_help", "Current Hake GeoDesk – Desktop GIS version string (alias of qgis_version)." ) );
  sVariableHelpTexts()->insert( u"hake_version_no"_s, QCoreApplication::translate( "variable_help", "Current Hake GeoDesk – Desktop GIS version number (alias of qgis_version_no)." ) );
  sVariableHelpTexts()->insert( u"hake_release_name"_s, QCoreApplication::translate( "variable_help", "Current Hake GeoDesk – Desktop GIS release name (alias of qgis_release_name)." ) );
  sVariableHelpTexts()->insert( u"hake_short_version"_s, QCoreApplication::translate( "variable_help", "Short Hake GeoDesk – Desktop GIS version string (alias of qgis_short_version)." ) );
  ...
  sVariableHelpTexts()->insert( u"hake_platform"_s, QCoreApplication::translate( "variable_help", "Hake GeoDesk – Desktop GIS platform, e.g., 'desktop' or 'server' (alias of qgis_platform)." ) );
  sVariableHelpTexts()->insert( u"hake_locale"_s, QCoreApplication::translate( "variable_help", "Two letter identifier for current Hake GeoDesk – Desktop GIS locale (alias of qgis_locale)." ) );
